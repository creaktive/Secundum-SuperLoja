...
$parceiro = "http://secundum.com.br/superloja/parceiro.php?p1=".$p1;

$ch = curl_init();$timeout = 15;
curl_setopt ($ch, CURLOPT_URL, $parceiro);
curl_setopt ($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt ($ch, CURLOPT_CONNECTTIMEOUT, $timeout);
$servidor = curl_exec($ch);
curl_close($ch);

$endereco = $servidor."?p1=".$p1."&p2=".$busca."&p3=".$filtro."&p4=".$completa."&p5=".$chave;
